    ...
    public function addTournoi(Request $request, ManagerRegistry $doctrine): Response
    {
        try {
            ...
            if (!empty($data['start_date'])) {
                ...
                $tournoi->setStartdate($startDate);
            }
            
            if (!empty($data['end_date'])) {
                $endDate = new \DateTime($data['end_date']);
                $tournoi->setEnddate($endDate);
            }
            ...
            return $this->json([
                ...
                'tournoi' => [
                    ...
                    'start_date' => $tournoi->getStartdate() ? $tournoi->getStartdate()->format('Y-m-d') : null,
                    'end_date' => $tournoi->getEnddate() ? $tournoi->getEnddate()->format('Y-m-d') : null,
